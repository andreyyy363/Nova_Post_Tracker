...
const PriceResult: React.FC<PriceResultProps> = ({ price, onCalculate, isLoading }) => {
        ...
        <View style={styles.resultContainer}>
          ...
          {price.CostPack > 0 && (
            <View style={styles.resultRow}>
              ...
              <Text style={styles.resultValue}>{price.CostPack.toFixed(2)} грн</Text>
            </View>
          )}
          
          <View style={styles.totalRow}>
            <Text style={styles.totalLabel}>Загальна вартість:</Text>
            <Text style={styles.totalValue}>{calculateTotalCost(price).toFixed(2)} грн</Text>
          </View>
        </View>
      )}
    </View>
